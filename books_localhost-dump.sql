...
CREATE TABLE `books_owned` (
  ...
  `done_reading` tinyint DEFAULT '0',
...
LOCK TABLES `books_owned` WRITE;
/*!40000 ALTER TABLE `books_owned` DISABLE KEYS */;
/*!40000 ALTER TABLE `books_owned` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `books_wishlist` WRITE;
/*!40000 ALTER TABLE `books_wishlist` DISABLE KEYS */;
/*!40000 ALTER TABLE `books_wishlist` ENABLE KEYS */;
UNLOCK TABLES;
